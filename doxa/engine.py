...
def next_cycle_mode(mode: "str | None", armed: bool = False) -> str:
    ...
    Since v0.56.0 that set is per-SESSION rather than global, which is a
...
class SessionEngine:
    ...
    def __init__(
        ...
        # (v0.56.0). Read once, here, at construction -- not per call --
    ...
    def _build_options(self) -> ClaudeAgentOptions:
        ...
        return ClaudeAgentOptions(
            ...
            **({"effort": effort} if effort else {}),
            ...
            # byte-identical to what it was before v0.56.0 -- adding a
