...
SCENES = ("hero", "repo-picker", "claude-session", "tool-activity", "tool-expanded", "restored-tool", "processing", "reasoning", "commands", "help", "needs-input", "permissions", "effort", "history", "queue", "memory")
