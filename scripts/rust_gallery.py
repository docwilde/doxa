...
SCENES = ("hero", "repo-picker", "tool-activity", "tool-expanded", "restored-tool", "processing", "reasoning", "commands", "help", "needs-input", "permissions", "effort", "history", "queue", "memory")
