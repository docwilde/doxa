...
reads live daemon registry entries through a required text redactor, reads and atomically writes TOML settings,
...
must supply its secret scrubber for registry reads. Registry results are advisory and must not be treated
